...
上篇文章[《走进Go的底层》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/qcrao-2018/p/10562216.html)中，我们学到了汇编这个工具，这次我们再次请出汇编来更深入地看看`slice`。如果没看过上篇文章，建议先回去看完，再继续阅读本文效果更佳。
...
【码洞《深度解析 Go 语言中「切片」的三种特殊状态》】[juejin.im/post/5bea58df](https://link.zhihu.com/?target=https%3A//juejin.im/post/5bea58df6fb9a049f153bca8)
